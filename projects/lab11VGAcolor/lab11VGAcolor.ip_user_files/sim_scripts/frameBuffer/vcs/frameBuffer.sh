...
#
# Script generated by Vivado on Fri May 10 05:08:23 +0200 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : frameBuffer.sh
...
#
# Usage        : frameBuffer.sh
#                frameBuffer.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                frameBuffer.sh [-reset_run]
#                frameBuffer.sh [-reset_log]
#                frameBuffer.sh [-help]
#
...
#                script (type 'frameBuffer.sh -help' for more information).
#
...
# script info
echo -e "frameBuffer.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./frameBuffer.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.frameBuffer xil_defaultlib.glbl -o frameBuffer_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./frameBuffer_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key frameBuffer_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc frameBuffer_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./frameBuffer.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: frameBuffer.sh [-help]\n\
Usage: frameBuffer.sh [-step]\n\
Usage: frameBuffer.sh [-lib_map_path]\n\
Usage: frameBuffer.sh [-reset_run]\n\
Usage: frameBuffer.sh [-reset_log]\n\
Usage: frameBuffer.sh [-keep_index]\n\
Usage: frameBuffer.sh [-noclean_files]\n\n\
