...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_18 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_dsp48_addsub_v3_0_6 -L xbip_dsp48_multadd_v3_0_6 -L xbip_multadd_v3_0_17 -L xil_defaultlib -L secureip -L xpm --snapshot multAdd xil_defaultlib.multAdd -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim multAdd -key {Behavioral:sim_1:Functional:multAdd} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb multAdd.wdb xsim.dir libdpi.so)
