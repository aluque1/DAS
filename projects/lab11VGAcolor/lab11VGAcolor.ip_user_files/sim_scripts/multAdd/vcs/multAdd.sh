...
design_libs=(xpm xbip_utils_v3_0_10 xbip_pipe_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_dsp48_multadd_v3_0_6 xbip_multadd_v3_0_17 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.multAdd xil_defaultlib.glbl -o multAdd_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./multAdd_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key multAdd_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc multAdd_simv.daidir vcs_lib c.obj)
