...
#
# Script generated by Vivado on Fri May 10 05:09:23 +0200 2024
...
#
# Usage        : multAdd.sh
#                multAdd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                multAdd.sh [-reset_run]
#                multAdd.sh [-reset_log]
#                multAdd.sh [-help]
#
...
#                script (type 'multAdd.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_10 -libname xbip_pipe_v3_0_6 -libname xbip_bram18k_v3_0_6 -libname mult_gen_v12_0_18 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_dsp48_addsub_v3_0_6 -libname xbip_dsp48_multadd_v3_0_6 -libname xbip_multadd_v3_0_17 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_10 xbip_pipe_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_dsp48_multadd_v3_0_6 xbip_multadd_v3_0_17 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "multAdd.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./multAdd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work xbip_multadd_v3_0_17 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.multAdd xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.multAdd -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log multAdd_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./multAdd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: multAdd.sh [-help]\n\
Usage: multAdd.sh [-step]\n\
Usage: multAdd.sh [-lib_map_path]\n\
Usage: multAdd.sh [-reset_run]\n\
Usage: multAdd.sh [-reset_log]\n\
Usage: multAdd.sh [-keep_index]\n\
Usage: multAdd.sh [-noclean_files]\n\n\
