...
HD_PWD='C:/Users/alv/Desktop/uni/DAS/projects/lab4iis/lab4iis.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4IIS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab4IIS.tcl -notrace
