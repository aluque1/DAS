...
HD_PWD='C:/Users/alv/Desktop/uni/DAS/projects/lab4iis/lab4iis.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4IIS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab4IIS.tcl
