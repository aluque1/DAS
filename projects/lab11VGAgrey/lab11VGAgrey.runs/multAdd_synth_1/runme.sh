...
HD_PWD='C:/Users/Administrator/Desktop/uni/DAS/projects/lab11VGAgrey/lab11VGAgrey.runs/multAdd_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multAdd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multAdd.tcl
