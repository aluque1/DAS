...
HD_PWD='C:/Users/Administrator/Desktop/uni/DAS/projects/lab11VGAgrey/lab11VGAgrey.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab11VGAgrey.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab11VGAgrey.tcl
